...
impl Codec {
    pub fn encode_varint32(&mut self, buffer: &mut Vec<u8>, value: i32) -> Result<(), &str> {
        self.encode_varint(buffer, value as i64)
    }

    pub fn decode_varint32(&mut self, buffer: Vec<u8>) -> Result<i32, &str> {
...
impl Codec {
    pub fn encode_varuint32(&mut self, buffer: &mut Vec<u8>, value: u32) -> Result<(), &str> {
        self.encode_varint(buffer, value as i32 as i64)
    }

    pub fn decode_varuint32(&mut self, buffer: Vec<u8>) -> Result<u32, &str> {
        match self.decode_varint(buffer) {
...
impl Codec {
    pub fn encode_varint64(&mut self, buffer: &mut Vec<u8>, value: i64) -> Result<(), &str> {
        self.encode_varint(buffer, value)
    }

    pub fn decode_varint64(&mut self, buffer: Vec<u8>) -> Result<i64, &str> {
...
impl Codec {
    pub fn encode_varuint64(&mut self, buffer: &mut Vec<u8>, value: u64) -> Result<(), &str> {
        self.encode_varint(buffer, value as i64)
    }

    pub fn decode_varuint64(&mut self, buffer: Vec<u8>) -> Result<u64, &str> {
        match self.decode_varint(buffer) {
...
impl Codec {
    pub fn encode_varint(&mut self, buffer: &mut Vec<u8>, value: i64) -> Result<(), &str> {
        if self.size == 0 {
    ...
    pub fn decode_varint(&mut self, buffer: Vec<u8>) -> Result<i64, &str> {
        if self.size == 0 {
            return Err("nothing to encode");
        }
        let mut value: i64 = 0;
